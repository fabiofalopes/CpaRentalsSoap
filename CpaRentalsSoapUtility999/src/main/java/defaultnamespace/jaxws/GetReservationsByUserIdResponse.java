...
@XmlRootElement(name = "getReservationsByUserIdResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getReservationsByUserIdResponse", namespace = "http://default_package/")
